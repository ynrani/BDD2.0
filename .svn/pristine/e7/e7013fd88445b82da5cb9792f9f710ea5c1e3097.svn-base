...
<body onload="loadbody()">
	...
	%>
			...
			<div class="container tdm-central"
				style="margin-bottom: 94px; overflow: hidden;">

				<form name="encryption" method="post" action="ConfigureServlet"
					onsubmit="checkSubmit();">
					<div class="row">
						<p>Please provide below configuration details</p>
					</div>
					<div class="row">
						<span> <input class="balloon" id="state" name="state"
							type="text" placeholder="e.g. C://TEST" /><label for="state">Feature
								file download path</label>
						</span> <span> <input class="balloon" id="extention"
							name="extention" type="text" placeholder="e.g .feature" /><label
							for="planet">File extension</label>
						</span> <span> <input class="balloon" id="galaxy" type="text"
							placeholder="Rally URL" /><label for="galaxy">Rally URL</label>
						</span> <span> <a href="AddNewTool.jsp?queryResponse=0" ><input
								class="balloon" name="button3" id="Add"
								value="Add Tool" /></a>
						</span> <span> <a href="Setting.jsp" target="m_page"><input
								class="balloon" type="submit" name="button1" id="File"
								value="Submit" /></a>
						</span> <span> <a href="Setting.jsp" target="m_page"><input
								class="balloon" type="submit" name="button2" id="Refresh"
								value="Refresh Data" /></a>
						</span>
					</div>
				</form>
