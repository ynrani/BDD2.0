...
a.captionOrange, a.captionOrange:active, a.captionOrange:visited, a.captionTextWhite,
	a.captionTextWhite:active, a.captionTextWhite:visited {
	color: #fff;
...
.tdmSeshub01 div:hover, .tdmSeshub01 .av:hover {
...
.tdmSeshub01 .dn, .tdmSeshub01 .dn:hover {
...
.tdmSeshua05l.tdmSeshua05ldn {
	background-position: -250px -40px;
}

.tdmSeshua05r.tdmSeshua05rdn {
...
.tdmSeshua02l.tdmSeshua02ldn {
	background-position: -3px -33px;
}

.tdmSeshua02r.tdmSeshua02rdn {
	background-position: -63px -33px;
}
</style>
</head>
