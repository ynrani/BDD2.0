...
</script> <section class="top-blue-nav"> <!--Primary Navigation Menu Start-->
<div class="container">
	<div class="primary-nav">
		<nav>
		<ul>
			<li><font face="Calibri" color="green"><a
					href="FinalLanding1.jsp"><img src="images/home1.jpg" width="30"
						height="30" alt="" />Home</a></font>></li>
...
<!--Primary Navigation Menu Ends--> </section> <section class="navigation">
<div class="logo">
...
<body onFocus="parent_disable();" onclick="parent_disable();">
							...
							<table class="page2-table">
								<tbody>
									<div class=WordSection1>
										...
										<p class=MsoNormal>
											<b><span style='color: #002060'>Automation COE
													team<o:p></o:p>
											</span></b>
										</p>
 ...
 <v:imagedata src="Contact_files/image001.gif" o:href="cid:image004.gif@01D0D9DE.006E9A80"/>
												...
												Automation COE<br>
											</span><span style='color: #0070C0'><a
												href="http://www.capgemini.com/financialservices/"><span
													style='font-size: 10.0pt; line-height: 115%'>www.capgemini.com/financialservices/</span></a></span><span
												style='font-size: 10.0pt; line-height: 115%; color: #0070C0'><o:p></o:p></span>
										</p>
	...
	<div class="footerDivToStickToBottom">
		<jsp:include page="FooterStatic.jsp"></jsp:include>
