            ...
            <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 960px; height: 450px;
                ...
                <div>
                    ...
                    <div id="slider1_container" style="position: relative; top: 90px; left: 0px; width: 600px;
                        ...
                        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 600px; height: 300px; overflow: hidden;">
                            <div>
                                <a u="image" href="#"><img src="images/photography/bdd-the-unit-test-of-the-product-owner-17-638.jpg" alt="image slider" /></a>
                                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                                Only 25% effort is involved in TDM
                                </div>
                            </div>
                            <div>
                                <a u="image" href="#"><img src="images/photography/bdd_gwt.png" alt="jqeury image slider" /></a>
                                <!-- 
                                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                            ...
                            <div>
                                <a u="image" href="#"><img src="images/photography/agile-testing-framework-1509@2x.png" alt="responsive image slider" /></a>
                                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                                Centralized TDM governance
                                </div>
                            </div>
                            <div>
                                <a u="image" href="#"><img src="images/photography/image17.png" alt="touch swipe image slider" /></a>
                                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                ...
                <div>
					...
					<div id="slider2_container" style="position: relative; top: 90px; left: 0px; width: 600px;
                        ...
                        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 600px; height: 300px; overflow: hidden;">
                            <div>
                                <a u="image" href="#"><img src="images/photography/service-layer-testing-using-bdd-for-legacy-products-4-638.jpg" alt="image slider" /></a>
                                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                                Find Test Data 
                                </div>
                            </div>
                            <!-- 
                            <div>
                                <a u="image" href="#"><img src="images/photography/Using BDD 2007 for Deployment Planning_1.jpg" alt="jqeury image slider" /></a>
                                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                            ...
                            -->
                            <div>
                                <a u="image" href="#"><img src="images/photography/bdd-the-unit-test-of-the-product-owner-17-638.jpg" alt="responsive image slider" /></a>
                                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                                Reduces manual searches for test data
                                </div>
                            </div>
                            <div>
                                <a u="image" href="#"><img src="images/photography/its-testing-jim-but-not-as-we-know-it-bdd-for-testers-14-638.jpg" alt="touch swipe image slider" /></a>
                                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                ...
                <div>
                    ...
                    <!-- To move inline styles to css file/block, please specify a class name for each element. --> 
                     <div id="slider3_container" style="position: relative; top: 90px; left: 0px; width: 600px;
                        ...
                        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 600px; height: 300px; overflow: hidden;">
                            <div>
                                <a u="image" href="#"><img src="images/photography/agile-testing-framework-1509@2x.png" alt="image slider" /></a>
                                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                                Only 30% effort is involved in masking
                                </div>
                            </div>
                            <div>
                                <a u="image" href="#"><img src="images/photography/image17.png" alt="jqeury image slider" /></a>
                                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                                Consistent data masking
                                </div>
                            </div>
                            <div>
                                <a u="image" href="#"><img src="images/photography/productBacklogGrooming.jpg" alt="responsive image slider" /></a>
                                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                                Hiding sensitive
                                </div>
                            </div>
                            <div>
                                <a u="image" href="#"><img src="images/photography/productOwnerInteractions.jpg" alt="touch swipe image slider" /></a>
                                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
